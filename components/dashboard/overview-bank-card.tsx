...
export function OverviewBankCard() {
  ...
  return (
    <motion.div
      ...
      className="relative col-span-12 overflow-hidden rounded-2xl bg-neutral-950 p-6 text-white shadow-[0_30px_60px_-20px_rgba(15,17,15,0.55)] xl:col-span-5"
    >
      <div
        aria-hidden
      ...
      <div className="relative flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="ml-2 inline-flex items-center gap-1.5 font-mono text-[11px] tracking-wide text-neutral-200">
      ...
      <div className="relative mt-7">
        ...
        <div className="mt-2 font-display text-[44px] font-semibold tabular-nums tracking-[0.1em] text-white">
          {head}
